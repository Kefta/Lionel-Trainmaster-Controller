...
#define __TRAIN_ACCESSORY_DATA(NAME, COMMAND) __TRAIN_DATA(NAME, COMMAND, Accessory_SendCommand, TRAIN_ACCESSORY_MAXADDRESS)
#define __TRAIN_ACCESSORY_UDATA(NAME, COMMAND, MAX) __TRAIN_UDATA(NAME, COMMAND, MAX, Accessory_SendCommand, TRAIN_ACCESSORY_MAXADDRESS)
...
__TRAIN_ACCESSORY_DATA(Accessory_AUX2On, 15 /*0001111*/)
