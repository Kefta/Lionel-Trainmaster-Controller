...
__TRAIN_SENDCOMMAND(Engine_SendCommand, Engine_MaxAddress, Engine_MaxCommand, 0 /*00000000 00000000*/)

#define __TRAIN_ENGINE_DATA(NAME, COMMAND) __TRAIN_DATA(Engine_SendCommand, Engine_MaxAddress)
#define __TRAIN_ENGINE_UDATA(NAME, COMMAND, MAX) __TRAIN_UDATA(Engine_SendCommand, Engine_MaxAddress)
#define __TRAIN_ENGINE_IDATA(NAME, COMMAND, MIN, MAX) __TRAIN_IDATA(Engine_SendCommand, Engine_MaxAddress)
...
__TRAIN_ENGINE_UDATA(Engine_AssignToTrain, 48 /*0110000*/, Train_MaxAddress)
...
__TRAIN_ENGINE_UDATA(Engine_SetSpeed, 96 /*1100000*/, Engine_AbsoluteMaxSpeed)
__TRAIN_ENGINE_IDATA(Engine_ChangeSpeed, 64 /*1000000*/, Engine_RelativeMinSpeed, Engine_RelativeMaxSpeed)
