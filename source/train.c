...
__TRAIN_SENDCOMMAND(Train_SendCommand, TRAIN_TRAIN_MAXADDRESS, TRAIN_TRAIN_MAXCOMMAND, 0xC800 /*11001000 00000000*/)

#define __TRAIN_TRAIN_DATA(NAME, COMMAND) __TRAIN_DATA(NAME, COMMAND, Train_SendCommand, TRAIN_TRAIN_MAXADDRESS)
#define __TRAIN_TRAIN_UDATA(NAME, COMMAND, MAX) __TRAIN_UDATA(NAME, COMMAND, MAX, Train_SendCommand, TRAIN_TRAIN_MAXADDRESS)
#define __TRAIN_TRAIN_IDATA(NAME, COMMAND, MIN, MAX) __TRAIN_IDATA(NAME, COMMAND, MIN, MAX, Train_SendCommand, TRAIN_TRAIN_MAXADDRESS)
...
__TRAIN_TRAIN_UDATA(Train_SetSpeed, 96 /*1100000*/, TRAIN_TRAIN_ABSOLUTEMAXSPEED)
__TRAIN_TRAIN_IDATA(Train_ChangeSpeed, 64 /*1000000*/, TRAIN_TRAIN_RELATIVEMINSPEED, TRAIN_TRAIN_RELATIVEMAXSPEED)
